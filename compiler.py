...
def compile_to_c(code, output_c_file):
    ...
    def infer_type(node, func_name=None):
        ...
        if isinstance(node, CallNode):
            ...
            if node.name == '\u0631\u06cc\u0634\u0647_\u062f\u0648\u0645': return 'double'
            if node.name == '\u0642\u062f\u0631_\u0645\u0637\u0644\u0642': return 'double'
            if node.name == '\u0633\u0642\u0641': return 'double'
            if node.name == '\u06a9\u0641': return 'double'
            if node.name == '\u0637\u0648\u0644_\u0631\u0634\u062a\u0647': return 'int'
            if node.name == '\u0628\u0632\u0631\u06af\u200c\u06a9\u0646': return 'string'
            if node.name == '\u06a9\u0648\u0686\u06a9\u200c\u06a9\u0646': return 'string'
            if node.name == '\u0631\u06cc\u0634\u0647_\u062f\u0648\u0645': return 'double'
            if node.name == '\u0642\u062f\u0631_\u0645\u0637\u0644\u0642': return 'double'
            if node.name == '\u0633\u0642\u0641': return 'double'
            if node.name == '\u06a9\u0641': return 'double'
    ...
    c_code += (
        ...
        '    return buf;\n'
        '}\n\n'
            'double fs_sqrt(double x) { return sqrt(x); }\n'
            'double fs_abs(double x) { return fabs(x); }\n'
            'double fs_ceil(double x) { return ceil(x); }\n'
            'double fs_floor(double x) { return floor(x); }\n'
            'int fs_strlen(const char* s) { return strlen(s); }\n'
            'void fs_toupper(char* s) { for (; *s; s++) *s = toupper(*s); }\n'
            'void fs_tolower(char* s) { for (; *s; s++) *s = tolower(*s); }\n'
            'double fs_sqrt(double x) { return sqrt(x); }\n'
            'double fs_abs(double x) { return fabs(x); }\n'
            'double fs_ceil(double x) { return ceil(x); }\n'
            'double fs_floor(double x) { return floor(x); }\n'
