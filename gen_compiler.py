...
# This script writes compiler.py using only ASCII-safe strings.
# Persian words are represented with \u escapes.
compiler_code = r'''
...
print("compiler.py has been generated successfully.")