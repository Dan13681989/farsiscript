...
# ---- 2. Add current_time() helper after __try_signal_handler ----
for i, line in enumerate(lines):
...
# ---- 3. Insert library functions in gen_expr after the خطا_بده block ----
target = None
for i, line in enumerate(lines):
...
# ---- 4. Insert library functions in gen_stmt after خطا_بده ----
target_stmt = None
for i, line in enumerate(lines):
...
# ---- 7. Handle 'int' type in PrintNode ----
for i, line in enumerate(lines):
...
print("Standard library inserted successfully")